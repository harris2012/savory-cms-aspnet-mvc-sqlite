...
namespace SavoryCms.Repository
{
    public interface IMetaRepositoryTypeRepository
    {
        ...
        /// <returns>实体</returns>
        MetaRepositoryTypeEntity GetById(long id);
        ...
        /// <returns>实体列表</returns>
        List<MetaRepositoryTypeEntity> GetEntityList(int pageIndex, int pageSize);
        ...
        void Create(MetaRepositoryTypeEntity entity);

        /// <summary>
        /// 更新实体
        /// </summary>
        /// <param name="entity">要更新的实体</param>
        void Update(MetaRepositoryTypeEntity entity);
    }
}
